...
## Delay
- Higher delay reduces risk of rate limiting. (2022-02-08)
...
## Port 587
- Commonly used for STARTTLS. (2022-02-18)

## Tip
- Test with a small mail list first. (2022-02-28)
...
## Gmail
- Use App Password if 2FA is enabled. (2022-05-23)
...
## Progress
- Sent count shown during bulk send. (2023-01-23)

## UI
- Load Mail List, Test Connection, Send Message. (2023-08-05)
...
## Progress
- Sent count shown during bulk send. (2023-07-09)
...
## Progress
- Sent count shown during bulk send. (2023-06-10)
