...
class SmtpEngine:
    def __init__(self):
        ...
        self.invalid_port = "Please provide a valid port number"
    ...
    def complete(self):
        mb.showinfo(title="Success", message=f"Message sent successfully to {self.count} Recipient")
    ...
    def port_invalid(self):
        mb.showerror(title="Port Error", message=f"{self.invalid_port}")
